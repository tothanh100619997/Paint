 ...
 * @author toth
 */
public class MyRhombus implements Hinh2D {
    ...
    public void makeObject(Point startDrag, Point endDrag) {
        ...
        setB(new Point(startDrag.x + (endDrag.x - startDrag.x), startDrag.y + (endDrag.y - startDrag.y) / 2));
        setC(new Point(startDrag.x, endDrag.y));
        setD(new Point(startDrag.x - (endDrag.x - startDrag.x), startDrag.y + (endDrag.y - startDrag.y) / 2));

    }

    public void makeRhombus(int x1, int y1, int x2, int y2, int x3, int y3, int x4, int y4) {
    ...
    public void scale(Point startDrag, Point endDrag) {
        ...
        if (p4.x < p2.x && p1.y < p3.y) {
            ...
            p3 = new Point(p3.x, p3.y + ydDrag + ydDrag + ydDrag);
            ...
            p1 = new Point(p1.x, p1.y + ydDrag + ydDrag + ydDrag);
            p2 = new Point(p2.x + xdDrag, p2.y + ydDrag);
            p3 = new Point(p3.x, p3.y - ydDrag);
            p4 = new Point(p4.x - xdDrag, p4.y + ydDrag);
        } else if (p4.x > p2.x && p1.y > p3.y) {
            p1 = new Point(p1.x, p1.y + ydDrag + ydDrag + ydDrag);
            p2 = new Point(p2.x - xdDrag, p2.y + ydDrag);
