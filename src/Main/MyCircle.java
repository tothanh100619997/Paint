...
public class MyCircle extends MyEllip {
    ...
    public void makeObject(Point startDrag, Point endDrag) {
        ...
        setA(new Point(startDrag.x - (endDrag.x - startDrag.x), startDrag.y - (endDrag.x - startDrag.x)));
        setB(new Point(startDrag.x + (endDrag.x - startDrag.x), startDrag.y - (endDrag.x - startDrag.x)));
        setC(new Point(startDrag.x + (endDrag.x - startDrag.x), startDrag.y + (endDrag.x - startDrag.x)));
        setD(new Point(startDrag.x - (endDrag.x - startDrag.x), startDrag.y + (endDrag.x - startDrag.x)));
    }
